const Menu = [
  ...
  //   ]
  // },
  { path: '/register', img: '/assets/img/logo/logo-bs4.png', title: 'Register' },

  // { path: '/campaccept', img: '/assets/img/logo/logo-bs4.png', title: 'CampAccept' },
  
  // { path: '/bootstrap-4', img: '/assets/img/logo/logo-bs4.png', title: 'New Camps' },

   { path: '/form/elements', icon: 'fa fa-list-ol', title: 'Create Camp',
  //   children: [
  ...
  //   ]
  // },
  { path: '/table/data', icon: 'fa fa-table', title: 'Camp History',
    // children: [
  ...
  //   ]
  // },
  { path: '/chart/apex', icon: 'fa fa-chart-bar', title: 'Data View'},
