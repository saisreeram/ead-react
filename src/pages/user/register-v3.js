				...
				<div className="right-content">
					...
					<div className="register-content">
						<form className="margin-bottom-0" onSubmit={this.handleSubmit}>
							...
							<label className="control-label">Enrollment Number <span className="text-danger">*</span></label>
							<div className="row m-b-15">
								<div className="col-md-12">
									<input type="text" className="form-control" placeholder="Enroll Number" required />
								</div>
							</div>
							<label className="control-label">Create Password <span className="text-danger">*</span></label>
							<div className="row m-b-15">
								<div className="col-md-12">
